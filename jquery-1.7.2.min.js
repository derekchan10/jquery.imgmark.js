...
/*overwrite jquery getScript method*/
(function($){$.getScript=function(u,c,f){return $.ajax({type:'GET',url:u,success:c,dataType:'script',cache: !!f});}})(jQuery);
(function($){$.ajaxSetup({xhrFields: {withCredentials: true}})})(jQuery)
